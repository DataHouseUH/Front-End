...
import { AlertListService, BackDisplayService } from './alert-list.service';
import { data } from './alert-list';
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';
import { MatSnackBar } from '@angular/material/snack-bar';
import { BackDisplayTbl, AlertTbl } from './alert-list';
...
@Component({
  selector: 'app-alert-list',
  templateUrl: '../back-display/back-display.component.html',
  styleUrls: ['./alert-list.component.css']
})

export class BackDisplayComponent2 {
